...
steroids.config.name = "auxProject"
...
steroids.config.tabBar.tintColor = "#0077FF"
steroids.config.tabBar.tabTitleColor = "#000000"
steroids.config.tabBar.selectedTabTintColor = "#0033FF"
...
# ## Navigation Bar
steroids.config.navigationBar.tintColor = "#0077FF"
